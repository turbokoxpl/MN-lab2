# LAB 2
Na tych laboratoriach zapoznasz się z podstawowymi metodami numerycznymi i nauczysz się ich praktycznego wykorzystania w Pythonie. Będziesz korzystać z biblioteki Matplotlib, aby rysować i modyfikować wykresy różnych funkcji. W trakcie zajęć wykonasz obliczenia związane m.in. z ilością ciepła wydzielanego podczas hamowania i przedstawisz je w formie graficznej. Zobaczysz też, jak zmiana skali, zakresów czy sposobu prezentacji wpływa na czytelność wyników. Dzięki temu lepiej zrozumiesz, jak łączyć teorię z praktyką i jak wizualizacja pomaga w analizie danych.
...
5. Można tworzyć pomocnicze moduły/skrypty/klasy według uznania.
